...
import { TiHome, TiThLarge, TiShoppingBag, TiShoppingCart, TiDropbox, TiGroup, TiCog } from "react-icons/ti";
...
// Topbar menu structure used to render links
const menuItems = [
  { name: "Dashboard", path: "/admin-dashboard", icon: <TiHome />, isParent: true },
  { name: "Category", path: "/admin-dashboard/categories", icon: <TiThLarge />, isParent: false },
  { name: "Products", path: "/admin-dashboard/products", icon: <TiShoppingBag />, isParent: false },
  { name: "Warehouses", path: "/admin-dashboard/warehouses", icon: <FaWarehouse />, isParent: false },
  { name: "Orders", path: "/admin-dashboard/orders", icon: <TiShoppingCart />, isParent: false },
  { name: "To-Order", path: "/admin-dashboard/to-order", icon: <TiDropbox />, isParent: false },
  { name: "Users", path: "/admin-dashboard/users", icon: <TiGroup />, isParent: false },
];
...
const Navbar = () => {
  ...
  useEffect(function () {
    function onEsc(e) { if (e.key === "Escape") setShowProfile(false); }
        ...
        <div className="px-2 sm:px-6 lg:px-8">
          <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                <span className="hidden sm:inline text-white text-lg font-bold">Inventory MS</span>
                <span className="sm:hidden text-white font-semibold">IMS</span>
              </div>
            </div>
